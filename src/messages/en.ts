...
header: {
  ...
  footer: {
    labels: {
      ...
      mailOrder: "Mail-order License"
    },
    company: "Ilwon Company Co., Ltd.",
    businessNumber: "627-81-02476",
    representative: "Ohhee Kim",
    mailOrderNumber: "",
    hostingProvider: "AWS",
    customerService: "stayonekoreaofficial@gmail.com",
    inquiryAddress: "B1 102-Ga93ho, 55 Gojan-ro, Danwon-gu, Ansan-si, Gyeonggi-do, Republic of Korea",
  ...
  payment: {
    ...
    processingMessage: "Payment processing may take up to 5 minutes. Please wait.",
