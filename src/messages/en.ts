...
header: {
  ...
  payment: {
    ...
    alipayProcessing: "Processing Alipay payment...",
    unionpayProcessing: "Processing UnionPay payment...",
    bookNow: "Pay now",
    processing: "Processing payment...",
    configError: "Payment settings are not configured. Please contact support.",
    paymentFailed: "Payment failed",
    paymentError: "An error occurred during payment.",
    confirmFailed: "Payment completed but server confirmation failed. Please check My Page.",
    ourPrice: "Our price",
    discount: "Discount"
  },
  like: {
