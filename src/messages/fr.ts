...
header: {
  ...
  payment: {
    ...
    alipayProcessing: "Traitement du paiement Alipay...",
    unionpayProcessing: "Traitement du paiement UnionPay...",
    bookNow: "Payer maintenant",
    processing: "Traitement du paiement...",
    configError: "Les paramètres de paiement ne sont pas configurés. Veuillez contacter l'administrateur.",
    paymentFailed: "Échec du paiement",
    paymentError: "Une erreur s'est produite lors du paiement.",
    confirmFailed: "Le paiement est terminé mais la confirmation serveur a échoué. Veuillez vérifier dans Ma page.",
    ourPrice: "Notre prix",
    discount: "Réduction"
  },
  like: {
