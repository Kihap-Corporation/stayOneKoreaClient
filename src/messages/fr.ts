...
header: {
  ...
  footer: {
    labels: {
      corporationName: "Raison sociale",
      representative: "Représentant",
      registrationNumber: "Numéro d'enregistrement",
      address: "Adresse",
      customerService: "Service client",
      hostingProvider: "Hébergeur",
      mailOrder: "Déclaration de vente à distance"
    },
    ...
    inquiryAddress: "B1 102-Ga93ho, 55 Gojan-ro, Danwon-gu, Ansan-si, Gyeonggi-do, République de Corée",
